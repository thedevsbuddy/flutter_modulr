...
import 'package:modulr/module/services/api_module_service.dart'
as modulr_api_service;
import 'package:modulr/module/services/local_module_service.dart'
as modulr_local_service;
...
class ServiceGenerator extends BaseGenerator {
  ...
  Future<void> generate() async {
    ...
    /// Write File
    Utils.writeFile(
        "$servicePath/${serviceName.snakeCase}_service.dart",
        serviceFile);
    Utils.writeFile(
        "$servicePath/local_${serviceName.snakeCase}_service.dart",
        serviceLocalFile);
    Utils.writeFile(
        "$servicePath/api_${serviceName.snakeCase}_service.dart",
        serviceApiFile);

    /// Show Success message
    print(green(
        '"$servicePath/${serviceName.snakeCase}_service.dart" generated successfully.'));
    print(green(
        '"$servicePath/local_${serviceName.snakeCase}_service.dart" generated successfully.'));
    print(green(
        '"$servicePath/api_${serviceName.snakeCase}_service.dart" generated successfully.'));
  }
}
